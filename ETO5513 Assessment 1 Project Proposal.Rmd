...
# Create a table of the burdens_over_time from 2000 and add caption
knitr::kable(tail(burdens_over_time, 21), caption = "Summary Statistics of All Risk Factor Health Burdens, 2000-2021", digits = 2)
```
